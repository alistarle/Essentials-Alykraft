...
public abstract class UserData extends PlayerExtension implements IConf
{
	...
	public final void reloadConfig()
	{
		...
		lastPvpTimestamp = _getLastPvpTimestamp();
		jail = _getJail();
		mails = _getMails();
	...
	private long _getLastPvpTimestamp()
	{
		return config.getLong("timestamps.lastpvp", 0);
	}
	...
	{
		System.out.println("On passe le godmode a : "+set);
		godmode = set;
